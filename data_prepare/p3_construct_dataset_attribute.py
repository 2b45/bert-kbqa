...
data_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data/ner_data')
file_name_list = ['train.csv', 'dev.csv', 'test.csv']

new_dir =  os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data/sim_data')
